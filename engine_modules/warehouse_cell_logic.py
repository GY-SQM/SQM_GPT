...
# ─────────────────────────────────────────────────────────────────────
# enforce 전역 스위치 (v8.6.9 — 운영 안정성 확보 후 단일 진입점 전환)
# ─────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────
# 9. 위치 형식 마이그레이션 분석 (v8.6.9 — 옛 형식 → 신규 형식)
# ─────────────────────────────────────────────────────────────────────
#
# 옛 형식 패턴 (v8.6.7 이전):
#   A-01-01      (3파트: 구역-열-층)
...
if __name__ == '__main__':
    ...
    # v8.6.9: 셀 상태 동적 계산 — In-memory mock DB 로 단독 검증
